...
\begin{figure}[!th]
    ...
    \caption{256-channel HydroCel Geodesic Sensor Net on Patient}
    \label{fig:eegsetup}
\end{figure}
...
\item Make DTI - DTIFIT and SCIRun

After the DWI images have been corrected, diffusion tensor images (DTI) are calculated using FSL's DTIFIT. 
