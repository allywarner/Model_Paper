...
%tried a lot of software - lots of different areas of imaging
%We estimate somebody following these instructions would take 100 hours of segmentation, but the rest of the pipeline could be completed in (some estimate)
