...
COMMAND LINE ARUGEMNTS

\texttt{fslroi DWI\_up b0\_up 0 1
fslroi DWI\_down b0\_down 0 1}

\texttt{fslmerge -t both\_b0 b0\_up b0\_down}

\texttt{topup --imain=both\_b0 --datain=acq_params.txt --config=mine.cnf --out=topup\_results
applytopup --imain=b0\_up,b0\_down --inindex=1,2 --datain=acq_params.txt --topup=topup\_results --out=b0\_hifi}

\texttt{bet b0\_hifi b0\_hifi\_brain -m -f 0.2
...
These commands . The distortion corrected file is named "eddy\_unwarped.nii."
