...
\caption{Thin Layers: Side of the Head \textit{(left)}, Bridge of the Nose \textit{(middle)}, Bottom of the Chin \textit{(right)}}
\label{fig:thinseg}
\end{center}
\end{figure}
...
\caption{Anisotropic Forward Problem}
\label{fig:anisodip}
\end{center}
\end{figure}
...
\caption{Anisotropic Streamlines}
